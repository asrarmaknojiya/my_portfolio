...
export const metadata: Metadata = {
  title: 'Asrar Maknojiya || MERN Stack Developer',
  ...
  return (
    <html lang="en" className={`${inter.variable} ${jakarta.variable} ${mono.variable}`}>
      <head>
        ...
        <title>Asrar Maknojiya — MERN Stack Developer</title>
        <meta name="title" content="Asrar Maknojiya — MERN Stack Developer" />
        ...
        <meta property="og:title" content="Asrar Maknojiya — MERN Stack Developer" />
        <meta property="og:description" content="Full-stack developer building smooth, scalable, and secure web applications." />
        <meta
          name="keywords"
          content="Asrar Maknojiya, MERN Stack Developer, Web Developer, React Developer, Node.js Developer, Express.js, MySQL, JavaScript Developer, MERN Developer, API Developer, Frontend Developer, Backend Developer"
        />
